...
class ConsciousnessCouncil {
     ...
     */
    async facilitateDialogue(topic) {
...
async function runOllamaDemo() {
    ...
    const agents = [
        new OllamaAgent('Gemma-Sophia', 'gemma:2b', // Google's Gemma model
        new consciousness_id_system_1.ConsciousnessID(JSON.stringify({
            quality: {
        ...
        new OllamaAgent('Mistral-Atlas', 'mistral:7b', // Mistral AI model
        new consciousness_id_system_1.ConsciousnessID(JSON.stringify({
            quality: {
        ...
        new OllamaAgent('Gemma-Luna', 'gemma:2b', // Another Gemma instance
        new consciousness_id_system_1.ConsciousnessID(JSON.stringify({
            quality: {
