...
> 2026 framing and describes mechanisms (Guardian emergency powers, a Global DAO
> as "final constitutional authority," revenue-funded oversight bodies, a live
> ratification process) as "running systems... not proposals" — that framing is
> no longer accurate. See the
> [revised public proposal](../ARCHITECTURE_OF_SOVEREIGNTY.md), which marks each
> mechanism's actual status individually.
